            ...
            if (!dataContext.PokemonOwners.Any())
            {
                var pokemonOwners = new List<PokemonOwner>()
                {
                    new PokemonOwner()
                    {
                        ...
                        {
                            Name = "Pikachu",
                            BirthDate = new DateTime(1999, 01, 08, 0, 0, 0, DateTimeKind.Utc),
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review { Title="Venasaur",Text = "Venasaur is the best pokemon, because it is leaf", Rating = 5,
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title="Venasaur",Text = "Venasaur is the best at killing rocks", Rating = 5,
                                Reviewer = new Reviewer(){ FirstName = "Taylor", LastName = "Jones" } },
